                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="<?php echo e(route('restorants.create')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Add Restaurant')); ?></a>
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $restorants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $restorant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><a href="<?php echo e(route('restorants.edit', $restorant)); ?>"><?php echo e($restorant->name); ?></a></td>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                        ...
                                                        <form action="<?php echo e(route('restorants.destroy', $restorant)); ?>" method="post">
                                                            <?php echo csrf_field(); ?>
                                                            ...
                                                            <?php endif; ?>
                                                            <a class="dropdown-item" href="<?php echo e(route('restorants.edit', $restorant)); ?>"><?php echo e(__('Edit')); ?></a>
...
<?php echo $__env->make('layouts.app', ['title' => __('Restaurants')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zebra-qr.com\resources\views/restorants/index.blade.php ENDPATH**/ ?>