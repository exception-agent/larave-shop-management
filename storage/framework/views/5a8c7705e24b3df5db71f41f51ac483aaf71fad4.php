<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <!-- Heading -->
            <?php if(auth()->check() && auth()->user()->hasRole('admin')): ?>
            <h6 class="navbar-heading text-muted"><?php echo e(__('Version')); ?> <?php echo e(config('app.version')); ?>   <span id="uptodate" class="badge badge-success" style="display:none;"><?php echo e(__('latest')); ?></span></h6>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\zebra-qr.com\resources\views/layouts/navbars/sidebar.blade.php ENDPATH**/ ?>