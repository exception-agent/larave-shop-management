    ...
    <div class="container">
        <div class="row justify-content-center mb-5 mb-lg-7">
            <div class="col-12 col-md-8 text-center">
                <h1 class="h1 font-weight-bolder mb-4"><?php echo e(__('qrlanding.testimonials_title')); ?></h1>
                <p class="lead"><?php echo e(__('qrlanding.testimonials_subtitle')); ?></p>
            </div>
        </div>
...
<?php /**PATH F:\Laravel\Mohamed\zebra-qr.com\resources\views/qrsaas/partials/testimonials.blade.php ENDPATH**/ ?>