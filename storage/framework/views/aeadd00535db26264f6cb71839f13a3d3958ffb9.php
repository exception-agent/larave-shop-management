                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="<?php echo e(route('restorants.index')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Back to list')); ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="pl-lg-4">
                            <form method="post" action="<?php echo e(route('restorants.store')); ?>" autocomplete="off">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', ['title' => __('Restaurant Management')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zebra-qr.com\resources\views/restorants/create.blade.php ENDPATH**/ ?>